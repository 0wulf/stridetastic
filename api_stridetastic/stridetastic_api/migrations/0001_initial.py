    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        choices=[("MQTT", "MQTT"), ("SERIAL", "Serial")],
                        default="MQTT",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether this interface should be started.",
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Last runtime error message, if any.",
                        null=True,
                    ),
                ),
                (
                    "config",
                    models.JSONField(
                        blank=True, help_text="Arbitrary configuration blob.", null=True
                    ),
                ),
                (
                    "mqtt_broker_address",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the snapshot was captured.",
                    ),
                ),
                (
                    "total_nodes",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Human readable capture session name.", max_length=128
                    ),
                ),
                (
                    "filename",
                    models.CharField(
                        help_text="Name of the generated PCAP file.", max_length=255
                    ),
                ),
                (
                    "file_path",
                    models.CharField(
                        help_text="Relative path where the PCAP is stored.",
                        max_length=512,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.PositiveBigIntegerField(
                        default=0,
                        help_text="Number of payload bytes written to the capture.",
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text="Timestamp when the capture started.",
                    ),
                ),
                (
                    "ended_at",
                    models.DateTimeField(
                        blank=True,
                        help_text="Timestamp when the capture ended.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Timestamp of the most recent packet written.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Optional metadata about the capture session.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "node_num",
                    models.BigIntegerField(
                        help_text="Unique number assigned to the node (0-x).",
                        unique=True,
                    ),
                ),
                (
                ...
                (
                    "mac_address",
                    models.CharField(
                        help_text="MAC address of the node.", max_length=18, unique=True
                    ),
                ),
                (
                    "short_name",
                    models.CharField(
                        blank=True,
                        help_text="Short name of the node.",
                        max_length=4,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Long name of the node.",
                        max_length=32,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Hardware model of the node.",
                        max_length=32,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the node is set as licensed operator.",
                    ),
                ),
                (
                    "role",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the node is set as unmessagable.",
                    ),
                ),
                (
                    "is_virtual",
                    models.BooleanField(
                        default=False,
                        help_text="Indicates if the node is managed as a virtual node.",
                    ),
                ),
                (
                    "latitude",
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Battery level of the device in percentage.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Uptime of the device in seconds.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        help_text="Indicates whether the most recent reactive traceroute attempt received a response.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Round-trip latency in milliseconds observed for the most recent reactive traceroute response.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the node was first seen.",
                    ),
                ),
                (
                    "last_seen",
                    models.DateTimeField(
                        auto_now=True,
                        help_text="Timestamp when the node was last seen.",
                    ),
                ),
                (
                    "interfaces",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the neighbor entry was processed.",
                    ),
                ),
                (
                    "advertised_node_id",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="stridetastic_api.neighborinfopayload",
                    ),
                ),
                (
                    "node",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "channel_num",
                    models.IntegerField(default=0, help_text="Channel Number (0-255)."),
                ),
                (
                    "psk",
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the channel was first seen.",
                    ),
                ),
                (
                    "last_seen",
                    models.DateTimeField(
                        auto_now=True,
                        help_text="Timestamp when the channel was last seen.",
                    ),
                ),
                (
                    "interfaces",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="reactive_latency_history",
                        to="stridetastic_api.node",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the packet was received.",
                    ),
                ),
                (
                    "raw_data",
                ...
                (
                    "packet_id",
                    models.BigIntegerField(
                        blank=True, help_text="Identifier for the packet.", null=True
                    ),
                ),
                (
                    "rx_time",
                ...
                (
                    "hop_limit",
                    models.IntegerField(
                        blank=True, help_text="Hop limit for the packet.", null=True
                    ),
                ),
                (
                    "hop_start",
                    models.IntegerField(
                        blank=True, help_text="Hop start for the packet.", null=True
                    ),
                ),
                (
                    "first_hop",
                    models.IntegerField(
                        blank=True, help_text="First hop for the packet.", null=True
                    ),
                ),
                (
                    "next_hop",
                    models.IntegerField(
                        blank=True, help_text="Next hop for the packet.", null=True
                    ),
                ),
                (
                    "relay_node",
                    models.IntegerField(
                        blank=True,
                        help_text="Node that relayed the packet, if applicable.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        help_text="Indicates if the packet is delayed.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        help_text="Indicates if the packet was sent via MQTT.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the packet data was received.",
                    ),
                ),
                (
                    "portnum",
                    models.IntegerField(
                        blank=True,
                        help_text="Port number of the packet data.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("TEXT_MESSAGE_APP", "Text Message App"),
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="stridetastic_api.packetdata",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the position payload was received.",
                    ),
                ),
                (
                    "latitude",
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Sequence number of the position data.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hops",
                    models.IntegerField(
                        blank=True, help_text="Number of hops in the route.", null=True
                    ),
                ),
                (
                    "nodes",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("PKI_FAILED", "PKI Failed"),
                            ("PKI_UNKNOWN_PUBKEY", "PKI Unknown Public Key"),
                            ("ADMIN_BAD_SESSION_KEY", "Admin Bad Session Key"),
                            (
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="stridetastic_api.routediscoverypayload",
                    ),
                ),
                (
                    "route_request",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["last_activity"], name="stridetastic_last_ac_f5caa6_idx"
                    ),
                    models.Index(
                        fields=["is_bidirectional"],
                        name="stridetastic_is_bidi_bcaca7_idx",
                    ),
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("node_a", "node_b"), name="unique_logical_link_pair"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Timestamp when the edge was first seen.",
                    ),
                ),
                (
                    "last_seen",
                    models.DateTimeField(
                        auto_now=True,
                        help_text="Timestamp when the edge was last seen.",
                    ),
                ),
                (
                    "last_rx_rssi",
