...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='node',
            name='latency_ms',
            field=models.PositiveIntegerField(blank=True, help_text='Round-trip latency in milliseconds observed for the most recent probe response.', null=True),
        ),
        migrations.AddField(
            model_name='node',
            name='latency_reachable',
            field=models.BooleanField(blank=True, help_text='Indicates whether the most recent latency probe received a response.', null=True),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(help_text='Node associated with the probe result.', on_delete=django.db.models.deletion.CASCADE, related_name='latency_history', to='stridetastic_api.node')),
            ],
            options={
