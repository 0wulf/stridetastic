...
class PcapNgWriter:
	...
	def __init__(self, path: Path | str):
		...
		self._interface_id = self._write_interface_description_block(
			self._LINKTYPE,
			"meshtastic",
	...
	def _write_interface_description_block(self, link_type: int, name: str, proto_hint: str) -> int:
	...
	def write_mesh_packet(self, payload: bytes, timestamp: Optional[datetime] = None) -> None:
		self.write_packet(message_type="meshtastic.MeshPacket", payload=payload, timestamp=timestamp)

	def write_data_packet(self, payload: bytes, timestamp: Optional[datetime] = None) -> None:
		self.write_packet(message_type="meshtastic.Data", payload=payload, timestamp=timestamp)
